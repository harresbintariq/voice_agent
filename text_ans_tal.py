...
stop_words = ['a',  'about', 'across', 'after',  'almost', 'also', 'am', 'among', 'an',\
              ...
              'them', 'then', 'these', 'they', 'this', 'tis', 'to', 'too', 'twas', 'us', 'wants',
              'was',  'were',  'while', 'whom', 'why', 'will',
              'with', 'would', 'yet',  'your']

              
questions_list = ["hello Nadia ","how are you? ", "Tell us about yourself ",
                  "share the recharge number for today " , "what is the four g. forecast for october ",
                  "are you there ","good bye ","Hi","charge"]
...
def get_input(inp):
     ...
     if final_similarity_list[max_index] > 0.4:
